...
el usuario. El número está formado por p dígitos (más el signo), y de
esos p dígitos, d pertenecen a la parte decimal. Así, numeric(3,1)
permite que el número 44.5 se almacene exactamente, pero ni 444.5
ni 0.32 se pueden almacenar exactamente en un campo de este tipo.
• real, double precision. Números de coma flotante y números de
coma flotante de doble precisión, con precisión dependiente de la
máquina.
