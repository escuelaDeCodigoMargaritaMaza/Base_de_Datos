...
Las *__personas__* socias de la *__biblioteca__* disponen de un código de *__socio__* y además necesitar almacenar su *__ dirección, teléfono, nombre y apellidos__*.
